...
public class BottomIconView_2 extends LinearLayout {
    ...
    public BottomIconView_2(Context context) {
        super(context);
...
//    }
    ...
    public BottomIconView_2(Context context, String tag) {
        super(context);
        this.context = context;
        setTag(tag);
        findView();
    ...
    public BottomIconView_2(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.context = context;
        this.attrs = attrs;
        findView();
    ...
    public BottomIconView_2(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setModeView(String mode, String text, String selectIcon, String defaultIcon, String icon) {
            ...
            if (defaultIcon.equals("")) {
                if (!TextUtils.isEmpty(icon)) {
                    ...
                    if (iconRes != 0) {
                        ...
                        topIv.setImageResource(iconRes);
                    } else {
                        topIv.setVisibility(GONE);
                    }
                    LogUtil.e("----------------------设置图标-----------------------" + context.getResources().getIdentifier(icon + "_n", "mipmap", context.getPackageName()));
                } else {
                    topIv.setVisibility(GONE);
                    LogUtil.e("---------------------没有--图标-----------------------" + icon);
                }
            } else {
                topIv.setVisibility(VISIBLE);
            ...
            if (defaultIcon.equals("")) {
                if (!TextUtils.isEmpty(icon)) {
                    ...
                    if (iconRes != 0) {
                        ...
                        bottomIv.setImageResource(iconRes);
                    } else {
                        bottomIv.setVisibility(GONE);
                    }
                } else
            ...
            if (defaultIcon.equals("")) {
                if (!TextUtils.isEmpty(icon)) {
                    ...
                    if (iconRes != 0) {
                        ...
                        leftIv.setImageResource(iconRes);
                    } else {
                        leftIv.setVisibility(GONE);
                    }
                } else
            ...
            if (defaultIcon.equals("")) {
                if (!TextUtils.isEmpty(icon)) {
                    if (iconRes != 0) {
                        ...
                        rightIv.setImageResource(iconRes);
                    } else {
                        rightIv.setVisibility(GONE);
                    }
                } else
