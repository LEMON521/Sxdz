...
/**
 * 审批-新建-请假-添加请假明细ListView的数据适配器
 * Created by 靳宁宁 on 2017/2/21.
 */

public class ApproveNewLeaveAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<ApproveLeaveDao> list;

    public ApproveNewLeaveAdapter(Context context, ArrayList<ApproveLeaveDao> list) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(
                    R.layout.item_approve_new_leave, null);
            tag = new Holder();
            tag.matter = (EditText) convertView.findViewById(R.id.item_approve_leave_matter);
            tag.start = (EditText) convertView.findViewById(R.id.item_approve_leave_start_time);
            tag.end = (EditText) convertView.findViewById(R.id.item_approve_leave_end_time);
            tag.delect = (TextView) convertView.findViewById(R.id.item_approve_leave_delete);
            ...
            tag.start.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    PickerDialog.showDatePickerDialog(context, (EditText) v,"");
                }
            });
