...
public class ApproveJoinedDataItemsBean implements Serializable {
    ...
    public ArrayList<ApproveJoinedDataItemsUsersBean> node_users;
    public String title = "";
    public String userid = "";
    public String wf_id = "";
    public String wf_name = "";
    public String wf_type = "";
    public class ApproveJoinedDataItemsUsersBean{
        public String edit= "";
        public String id= "";
