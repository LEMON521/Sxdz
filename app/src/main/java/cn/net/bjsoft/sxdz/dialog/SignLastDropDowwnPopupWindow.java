...
import cn.net.bjsoft.sxdz.adapter.dailog.CheckListAdapter;
...
public class SignLastDropDowwnPopupWindow {
...
//    private ArrayList<String> levelList;
    ...
    private ArrayList<SignUserDataBean> stringList;
    private CheckListAdapter stringListAdapter;
    ...
    public SignLastDropDowwnPopupWindow(FragmentActivity activity
            , View view) {
    ...
    public void showWindow(ArrayList<SignUserDataBean> list, int[] location) {
...
//        });
    ...
    private void InitUI() {
        ...
        if (stringListAdapter == null) {
            stringListAdapter = new CheckListAdapter(mActivity, stringList);
        }
