 ...
 */
@ContentView(R.layout.fragment_approve_joined)
public class TopApproveJoinedFragment extends BaseFragment {

    @ViewInject(R.id.fragment_approve_joined)
    ...
    private PostJsonBean pushJoinedBean;
...
//                intent.putExtra("isEdited", bundle);
                ...
                new Handler() {
                    ...
                    public void handleMessage(Message msg) {
                        ...
                        if (!get_start.equals(get_count)) {
                            pushJoinedBean.start = get_start;//设置开始查询
    ...
    private void getData() {
        ...
        params.addBodyParameter("source_id", "workflow_joined");

        pushJoinedBean.start = get_start;//设置开始查询
        pushJoinedBean.limit = "10";
        params.addBodyParameter("data", pushJoinedBean.toString());
        LogUtil.e("-------------------------bean.toString()" + pushJoinedBean.toString());
