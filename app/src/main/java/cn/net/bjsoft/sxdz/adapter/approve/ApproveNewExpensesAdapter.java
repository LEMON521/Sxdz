...
public class ApproveNewExpensesAdapter extends BaseAdapter {

    private Context context;
    private ArrayList<ApproveExpensesDao> list;
    private TextView textView;
//    private Holder tag = null;


    public ApproveNewExpensesAdapter(Context context, ArrayList<ApproveExpensesDao> list, TextView textView) {
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(
                    R.layout.item_approve_new_expenses, null);
            //初始化控件
            tag = new Holder();
            tag.res = (EditText) convertView.findViewById(R.id.item_approve_expences_res);
            tag.unit_price = (EditText) convertView.findViewById(R.id.item_approve_expences_unit_price);
            tag.quantity = (EditText) convertView.findViewById(R.id.item_approve_expences_quantity);
            tag.money = (EditText) convertView.findViewById(R.id.item_approve_expences_money);
...
//            });
            ...
            tag.delect = (TextView) convertView.findViewById(R.id.item_approve_expences_delete);
