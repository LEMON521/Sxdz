...
public class RefreshListView_1 extends ListView implements OnScrollListener {
    ...
    private int mPullOrDown = 0;//1下拉,0默认情况,-1上拉
    private int mShifting = 0;//位移
...
//	};
    ...
    public RefreshListView_1(Context context) {
        super(context);
        //初始化刷新头
        initHeader();
        initFooter();
    ...
    public RefreshListView_1(Context context, AttributeSet attrs) {
        super(context, attrs);
        initHeader();
        initFooter();
        this.setOnScrollListener(this);
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                mPullOrDown = moveY - downY;
                LogUtil.e("mPullOrDown::" + mPullOrDown);
                mShifting = Math.abs(downY - moveY);
                //LogUtil.e("位移的值为::" + mShifting);

                if (customerView != null) {//不添加头的情况下,不包含刷新头
