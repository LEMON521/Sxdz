...
public class ApproveShowWaiteItemAdapter_new extends BaseAdapter {

    private Context context;
    private ArrayList<MessageApproveDataItemsBean> list;
    private int type = -1;

    public ApproveShowWaiteItemAdapter_new(Context context, ArrayList<MessageApproveDataItemsBean> list/*, int type*/) {
