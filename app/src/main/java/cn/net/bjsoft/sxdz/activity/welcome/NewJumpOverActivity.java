...
public class NewJumpOverActivity extends BaseActivity {
        ...
        public void handleMessage(Message msg) {
            if (seconds > 0) {
                ...
                if (!datasBean.data.authentication) {
                    Intent i3 = new Intent(NewJumpOverActivity.this, NewInitInfoActivity.class);
                    ...
                    if (datasBean.data.user.logined) {
                        Intent intent = new Intent(NewJumpOverActivity.this, NewInitInfoActivity.class);
                        ...
                        Intent i = new Intent(NewJumpOverActivity.this, LoginActivity.class);
